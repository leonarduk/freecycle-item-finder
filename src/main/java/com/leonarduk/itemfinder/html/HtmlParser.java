...
public class HtmlParser extends Parser {
     ...
     */
    public HtmlParser(final HttpURLConnection connection)
            throws ParserException {
        super(connection);
    }
     ...
     * (non-Javadoc)
     * @see
     * org.htmlparser.Parser#extractAllNodesThatMatch(org.htmlparser.NodeFilter)
     */
    @Override
    public final NodeList extractAllNodesThatMatch(final NodeFilter filter)
            throws ParserException {
