...
public class HtmlParserTest {
    ...
    public final void setUp() throws Exception {
        ...
        HtmlParserTest.filePathPrefix =
                "file://localhost" + System.getProperty("user.dir") + "/";
    }
    ...
    public final void testExtractAllNodesThatMatchNodeFilter()
        ...
        final NodeList nodeList =
                this.fullpostparser.extractAllNodesThatMatch(filter);
    ...
    public final void testParseNodeFilter() throws ParserException {
        final NodeList footer =
                this.fullpostparser.parse(new TagNameFilter("footer"));
